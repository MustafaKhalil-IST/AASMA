...
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        elif self.strat == 'proactive' and self.round==5: 
            if len(table) == 1:
                puxada = table[0]  #1st card played in the table
            if table == []:
                occ=[]
            ...
            if table != []:
                ...
                if selectable[0][1] == puxada[1]: #selectable contains one card of the same suit at least
                    ...
                    if len(aux3) > 5: #definimos jogar a mais alta ate haver 5 cartas do naipe (equivalente a 2 puxadas ja feitas)
                        ...
                        k=0
                        while k <= len(selectable)-1:
                            if selectable[k][0] < puxada[0]:
                                lst1 += [selectable[k]]
                            k+=1
                        if lst1 != [] and len(table) < 3:
                            chosen = max(lst1)
                        elif lst1 != [] and len(table)== 3: #se formos os ultimos a jogar
                            chosen = max(selectable)
                        else:
                            chosen = min(selectable)
                    ...
                    if puxada[1] == 'H':
                        if len(table) == 3:  #se formos os ultimos a jogar 
                            if (13, 'H') in table: #king na mesa
                                chosen = min(selectable) 
                            else:
                                chosen = max(selectable)
                        else:
                    ...
                    if (13, 'H') in table: #se o king estiver na mesa
                        chosen = min(selectable)
                    ...
                    if (13, 'H') in selectable: #à primeira oportunidade baldar o KING
                        chosen = (13, 'H')
                        escolhido = True
                        
                    if escolhido == False:
                        if (14, 'H') in selectable:      #baldar o ás de copas 
                            chosen = (14, 'H') 
                            escolhido = True
                            
                    occ=[] #number of cards in hand for each suit
                    nd=0    
                    nh=0
                    nc=0
                    ns=0
                    ...
                    while i <= len(occ)-1 and escolhido == False:
                        ...
                        if occ[i][0] > 0:
                            ...
                            if aux2[:len(aux)] != aux:  #se nao forem as mais baixas
                                chosen = max(aux)
                                escolhido = True
                            elif aux2[:len(aux)] == aux and i != 3 and escolhido == False: #se forem as mais baixas mas nao estamos no ultimo naipe
                                pass
                            elif aux2[:len(aux)] == aux and i == 3 and escolhido == False: 
                                chosen = min(aux)
                                escolhido = True            
                        i+=1
                self.hand.remove(chosen)
            # if chosen == (13, 'H'):
            #     print('KING')
            # print('chosen é: '+str(chosen))
            return chosen


        elif self.strat == 'proactive' and self.round == 6:
            if len(table) == 1:
                puxada = table[0]  #1st card played in the table
            if table == []:
                ...
                while i <= len(occ)-1 and escolhido == False:
                    if occ[i][0] > 0:
                        ...
                        if len(self.hand) <= 3:
                            if aux3 != [] and max(aux3) > min(aux): #passar o jogo 
                                chosen = min(aux)
                                escolhido = True
                        elif aux2[:len(aux)] != aux: #se nao tivermos as mais baixas
                            chosen = max(aux)
                            escolhido = True
                    i+=1
                if not escolhido:
            ...
            if table != []:
                ...
                if selectable[0][1] == puxada[1]: #selectable contains one card of the same suit at least
                    ...
                    if len(self.hand) > 3:
                        ...
                        chosen = min(selectable) if [card for card in selectable if card[0]<puxada[0]]==[] else max([card for card in selectable if card[0]<puxada[0]])
                        ...
                        if occ[i][0] > 0:
                            ...
                            while j <= len(selectable)-1:
                                if selectable[j][1] == occ[i][1]:
                                    aux += [selectable[j]]
                                j+=1
                            if aux2[:len(aux)] != aux: #se nao tivermos as mais baixas
                                chosen = max(selectable)
                                escolhido = True
        ...
        elif self.strat == 'proactive_coop' and self.round == 3:   #ronda das damas
            if len(table) == 1:
                puxada = table[0]  #1st card played in the table
            if table == []:
                occ=[]
                ...
                if selectable[0][1] == puxada[1]: #selectable contains one card of the same suit at least
                    ...
                    if dama == True and cartadama[1] == puxada[1] and ((len(table)==2 and table[0]==max([card for card in table if card[1]==table[0][1]])) or (len(table)==3 and table[1]==max([card for card in table if card[1]==table[0][1]]))):
                        chosen = max(selectable)
                    ...
                    if over12 == True:
                        ...
                        if ((len(table)==2 and table[0]==max([card for card in table if card[1]==table[0][1]])) or (len(table)==3 and table[1]==max([card for card in table if card[1]==table[0][1]]))):
                            if (12,selectable[0][1]) in selectable:
                                if max(selectable) == (12, selectable[0][1]) and len(selectable) > 1:
                                    chosen = selectable[-2]
                                else: 
                                    chosen = min(selectable)
                            else:
                            ...
                            if dama == True:
                                ...
                                while k <= len(aux)-1:
                                    if aux[k][0] < 12:
                                        under12 += [aux[k]]
                                    k+=1
                                if len(under12) < len(aux3) and  ((len(table)==2 and table[0]==max([card for card in table if card[1]==table[0][1]])) or (len(table)==3 and table[1]==max([card for card in table if card[1]==table[0][1]]))) and [item for item in selectable if item[0] != 12]!=[]:
                                    chosen = max([item for item in selectable if item[0] != 12])
                                    escolhido = True
                                   
                                elif ((len(table)==2 and table[0]==max([card for card in table if card[1]==table[0][1]])) or (len(table)==3 and table[1]==max([card for card in table if card[1]==table[0][1]]))):
                                    if max(selectable)[0] == 12:
                                        if len(selectable) == 1:
                                            chosen = max(selectable)
                                            escolhido = True
                                        elif [item for item in selectable if item[0] != 12]!=[]:
                                            chosen = max([item for item in selectable if item[0] != 12])
                                            escolhido = True
                ...
                if table == []:
                    ...
                    if selectable[0][1] == puxada[1]: #selectable contains one card of the same suit at least
                        ...
                        if homens == True:
                                ...
                                if carta == (11, selectable[0][1]) and len(table) == 3 and((len(table)==2 and table[0]==max([card for card in table if card[1]==table[0][1]])) or (len(table)==3 and table[1]==max([card for card in table if card[1]==table[0][1]]))):
                                    chosen = max(selectable)                           
                                selectable2= []   
                                ...
                                if carta == (13, selectable[0][1]) and len(table) == 3 and ((len(table)==2 and table[0]==max([card for card in table if card[1]==table[0][1]])) or (len(table)==3 and table[1]==max([card for card in table if card[1]==table[0][1]]))):
                                    chosen = max(selectable)
                                if carta == (13, selectable[0][1]) and len(table) == 2 and ((len(table)==2 and table[0]==max([card for card in table if card[1]==table[0][1]])) or (len(table)==3 and table[1]==max([card for card in table if card[1]==table[0][1]]))):
                                    chosen = max(selectable)
                        ...
                        if acima == True:
                            ...
                            if carta == (12, selectable[0][1]) and len(table) ==3 and ((len(table)==2 and table[0]==max([card for card in table if card[1]==table[0][1]])) or (len(table)==3 and table[1]==max([card for card in table if card[1]==table[0][1]]))):
                                selectable2 = []
                                selectable2 = [item for item in selectable if (item[0] != 11 or item[0] != 13)]
                                chosen = max(selectable2)
                            if carta == (12, selectable[0][1]) and len(table) == 2 and((len(table)==2 and table[0]==max([card for card in table if card[1]==table[0][1]])) or (len(table)==3 and table[1]==max([card for card in table if card[1]==table[0][1]]))):
                                if (13, selectable[0][1]) not in aux3 and (14, selectable[0][1]) in selectable:
                                    chosen = (14, selectable[0][1])
                                else:
                                    selectable2 = []
                                    selectable2 = [item for item in selectable if item[0] < 11]
                                    if selectable2 != []:
                                        chosen = max(selectable2)
                                    else: 
                                        min(selectable)
                            ...
                            if carta == (13, selectable[0][1]) and len(table) == 2 and ((len(table)==2  and table[0]==max([card for card in table if card[1]==table[0][1]])) or (len(table)==3 and table[1]==max([card for card in table if card[1]==table[0][1]]))):
                                    selectable2 = []
                                    selectable2 = [item for item in selectable if item[0] < 13]
                                    chosen = max(selectable)
                            if carta == (14, selectable[0][1]) and len(table)==3 and ((len(table)==2 and table[0]==max([card for card in table if card[1]==table[0][1]])) or (len(table)==3 and table[1]==max([card for card in table if card[1]==table[0][1]]))):
                                    chosen = max(selectable)
                            if carta == (14, selectable[0][1]) and len(table)==2 and ((len(table)==2 and table[0]==max([card for card in table if card[1]==table[0][1]])) or (len(table)==3 and table[1]==max([card for card in table if card[1]==table[0][1]]))):
                                    chosen = max(selectable)
                        ...
                        while i <= len(occ)-1 and escolhido == False:
                            ...
                            if escolhido == True and ((len(table)==2 and table[0]==max([card for card in table if card[1]==table[0][1]])) or (len(table)==3 and table[1]==max([card for card in table if card[1]==table[0][1]]))):
                                if chosen[0] == 11 or chosen[0] == 13:
                                    chosen = []
                                    escolhido = False
                            i+=1
                            ...
                            if occ[i][0] > 0:
                                ...
                                while j <= len(aux)-1:   #se tiver as ou dama -> baldar
                                    if aux[j][0] > 11: #and len(aux3) != []: #ver se carta nao esta seca
                                        over11 += [aux[j]]
                                    j+=1
                                if over11 != []: #escolhido == True and
                                    if ((len(table)==2 and table[0]==max([card for card in table if card[1]==table[0][1]])) or (len(table)==3 and table[1]==max([card for card in table if card[1]==table[0][1]]))):
                                        over11 = [item for item in aux if (item[0] != 11 and item[0] != 13)]
                                        if over11 != []:
                                            chosen = max(over11)
                                            escolhido = True
                                        else: 
...
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        elif self.strat == 'proactive_coop' and self.round==5: 
            # print('mao do a0: '+str(a0.hand))
            # print('mao do a1: '+str(a1.hand))
            # print('mao do a2: '+str(a2.hand))
            # print('mao do a3: '+str(a3.hand))
            ...
            if table != []:
                ...
                if selectable[0][1] == puxada[1]: #selectable contains one card of the same suit at least
                    ...
                    parceiro = False
                    #baldar o King
                    if (13, 'H') in selectable and (len(table) == 2 or len(table)==3) and ((len(table)==2 and table[0]==max([card for card in table if card[1]==table[0][1]])) or (len(table)==3 and table[1]==max([card for card in table if card[1]==table[0][1]]))):
                        selectable2 = []
                        selectable2 = [item for item in self.hand if item != (13, 'H')]
                        parceiro = True
                        ...
                        if escolhido == False:
                            ...
                            ns=0
                            j=0
                            while j <= len(selectable2)-1:
                                if selectable2[j][1] == 'D':
                                    nd+=1
                                if selectable2[j][1] == 'H':
                                    nh+=1
                                if selectable2[j][1] == 'C':
                                    nc+=1
                                if selectable2[j][1] == 'S':
                                    ns+=1
                                j+=1
                            occ = [[nd,'D'], [nh,'H'], [nc,'C'], [ns,'S']] #list of occurences for each suit 
                            occ = sorted(occ, key = lambda x: x[0])  
                            ...
                            while i <= len(occ)-1 and escolhido == False:
                                ...
                                if occ[i][0] > 0:
                                    ...
                                    k=0
                                    while k <= len(selectable2)-1:
                                        if selectable2[k][1] == occ[i][1]:
                                            aux += [selectable2[k]]
                                        k+=1
                    ...
                    elif (13,'H') in selectable and escolhido == False and parceiro == False:    
                        chosen = (13, 'H')
                        escolhido = True
        ...
        elif self.strat == 'proactive_coop' and self.round == 6:
            if table == []:
                occ=[] #number of cards in hand for each suit
                nd=0    
                nh=0
                ...
                while j <= len(self.hand)-1:
                    ...
                    j+=1
                occ = [[nd,'D'], [nh,'H'], [nc,'C'], [ns,'S']] #list of occurences for each suit 
                if [card for card in selectable if card[1] in self.partner]!=[]:
                    dry=[]
                    if 'D' in self.partner and [card for card in selectable if card[1]=='D']!=[]:
                        dry+=[occ[0]]
                    if 'H' in self.partner and [card for card in selectable if card[1]=='H']!=[]:
                        dry+=[occ[1]]
                    if 'C' in self.partner and [card for card in selectable if card[1]=='C']!=[]:
                        dry+=[occ[2]]
                    if 'S' in self.partner and [card for card in selectable if card[1]=='S']!=[]:
                        dry+=[occ[3]]
                    occ=sorted(dry, key = lambda x: -x[0])+sorted([x for x in occ if x not in dry], key = lambda x: -x[0])
                else:
                    occ = sorted(occ, key = lambda x: -x[0])
...
round5('proactive_coop','proactive_coop','proactive_coop','proactive_coop' )

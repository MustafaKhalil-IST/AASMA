                            ...
                            if dama == True:
                                ...
                                while k <= len(aux)-1:
                                    if aux[k][0] < 12:
                                        under12 += [aux[k]]
                                    k+=1
                                if len(under12) < len(aux3) and  ((len(table)==2 and table[0]==max([card for card in table if card[1]==table[0][1]])) or (len(table)==3 and table[1]==max([card for card in table if card[1]==table[0][1]]))):
                                    selectable = [item for item in selectable if item[0] != 12]
                                    print(selectable)
                                    chosen = max(selectable)
                                    escolhido = True
...
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        # elif self.strat == 'proactive_coop' and self.round==5: #Round 5: King 
...
round4('proactive_coop','proactive_coop','proactive_coop','proactive_coop')

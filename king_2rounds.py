...
class Agent:
    ...
    def play(self,table): 
        ...
        if self.strat=='random': # Strategy: plays a random card
            ...
            self.hand.remove(chosen)
            return chosen          
        elif self.strat == 'round1': #Strategy: jogar imediatamente abaixo no naipe (cc jogar a mais alta), baldar a carta mais alta do naipe com menos cartas
            ...
            if table == []:  #nao se pode jogar copas! 
                ...
                while k <= len(occ)-1 and escolhido == False:
                    if occ[k][0] > 0:
                        ...
                        if occ[k][1] == 'D':
                            aux3 = [x for x in diam if x not in selectable]       #naipe sem a mao do jogador 
                        if occ[k][1] == 'H':
                            aux3 = [x for x in hearts if x not in selectable]       #naipe sem a mao do jogador 
                        if occ[k][1] == 'C':
                            aux3 = [x for x in clubs if x not in selectable]       #naipe sem a mao do jogador 
                        if occ[k][1] == 'S':
                            aux3 = [x for x in spades if x not in selectable]       #naipe sem a mao do jogador 
                        j=0
                        while j <= len(selectable)-1:
                            ...
                            j += 1
                        if len(aux3) <= 5:
                            print('aux3 é menor que 5: '+str(aux3))
                            print(aux)
                        ...
                        if occ[i][0] == 1 and occ[i][1] != 'H': #se so tiver uma carta de um naipe
                            ...
                            while j <= len(selectable)-1:
                                if selectable[j][1] == 'H':
                                    aux += [selectable[j]]
                                j+=1
                            if hearts[:len(aux)] != aux: #Do we have the lowest hearts yet to play?
                                chosen = max(aux)
                                escolhido = True
                            elif hearts[:len(aux)] == aux and occ[3][1]== 'H' and occ[3][0] > 0:
                                chosen = max(aux)                        
...
#round2('play_high', 'play_high', 'play_high','play_high')
round2("round2","round2","round2","round2")
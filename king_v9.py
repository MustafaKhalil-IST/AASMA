...
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        elif self.strat == 'proactive' and self.round==5: #Round 4: Jacks and Kings !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            # print('mao do a0:'+ str(a0.hand))
            # print('mao do a1:'+ str(a1.hand))
            # print('mao do a2:'+ str(a2.hand))
            # print('mao do a3:'+ str(a3.hand))            
...
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                    ...
                    if occ[i][0] > 0:
                        ...
                        if aux2[:len(aux)] != aux: #se nao tivermos as mais baixas
                            if len(self.hand) > 3: 
                                chosen = max(aux)
                                escolhido = True
                            else:  #ultimas 3 jogadas
                                if aux3 != [] and max(aux3) > min(aux): #passar o jogo 
                                    chosen = min(aux)
                                    escolhido = True
                                elif aux3 != [] and min(aux3) > max(aux): #ardeste amigo 
                                    chosen = min(aux)
                                    escolhido =True
                                else:
                                    chosen = min(selectable)
                        ...
                        elif aux2[:len(aux)] == aux and i == 0:  #vais so puxar uma carta seca pq te enterraste e es uma merda 
                            #print('puxar carta seca')
                            chosen = max(selectable)
                            escolhido = True
                    i+=1
            ...
            if table != []:
                ...
                if selectable[0][1] == puxada[1]: #selectable contains one card of the same suit at least
                    ...
                    # naipe = max(occ)[1]
                    # print('naipe com mais cartas: '+str(naipe))
...
round6("proactive","proactive","proactive","proactive")
